...
def header(param,step):
    ...
    sout+="""# -*- coding: utf-8 -*-\n"""
    sout+="""#\n"""
    sout+="""#SBATCH --job-name="""+step+"""                                           #@@@ fill with appropriate value\n"""
    sout+="""#SBATCH --mail-user="""+param["SLURMemailaddress"]+"""                    #@@@ fill with appropriate value: valid email address\n"""
    sout+="""#SBATCH --mail-type="""+param["SLURMemailtype"]+"""                                          #@@@ fill with appropriate value: here, email sent at the END of job\n"""
    sout+="""#SBATCH --output="""+param["SLURMlog"]+"""slurm-"""+step+"""-%j.out         #@@@ fill with appropriate value: output log file\n"""
    sout+="""#\n"""
    ...
    sout+="""#SBATCH --array="""+param["SLURMarray"]+"""                                              #@@@ fill with appropriate value: here samples 1 to 4\n"""
    sout+="""\n"""
    sout+="""echo "************** SLURM ENV ******************"\n"""
