...
def GenotypingAndRecalibrating(param):
    ...
    sout+="""perl $SRC/ensembl-tools-release-77/scripts/variant_effect_predictor/variant_effect_predictor.pl -i $resvcfdir/$prefix$middfix_recal_final.vcf --cache --everything --vcf --force_overwrite\n"""
    sout+="""$SRC/vcfsorter.pl $dict variant_effect_output.txt > $resvcfdir/$prefix$middfix_recal_final_VEP.vcf \n"""
    sout+="""mv variant_effect_output.txt_summary.html $resvcfdir/$prefix$middfix_recal_final_VEP_summary.html \n"""
    sout+="""\n"""
    sout+="""echo "************** Finished ******************"\n"""
