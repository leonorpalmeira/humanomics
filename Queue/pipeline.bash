...
#queuescript=$HOME"/scripts/work/rodrigo/gatk.qpp.scala"
echo "============== Started =================="
echo `date`
cd $GLOBALSCRATCH"/work/testing-humanomics/Queue" #"work/rodrigo/map/"
# NOTE to self:
...
queuescript=$HOME"/scripts/humanomics/Queue/HumanomicsPipeline.scala"
jobpars=""
inputdir=$GLOBALSCRATCH"/work/testing-humanomics/Queue/raw-data"
...
outputdir=$GLOBALSCRATCH"/work/testing-humanomics/Queue/res"
...
$JAVAcustom ${GATK}"/Queue.jar" \
    -S $queuescript \
    -I1 $inputdir"/R120807_CM_L004_R1.fastq.gz" \
    -I2 $inputdir"/R120807_CM_L004_R2.fastq.gz" \
    -RG "@RG\\tID:SampleCM\\tSM:SampleCM\\tLB:Sample\\tPL:illumina\\tPU:hiseq\\tCN:null\\tDS:Instrument_HISEQ" \
    -snps $GLOBALSCRATCH"/genomes/homo_sapiens/hg19/variation/dbsnp_137.hg19_sorted.vcf" \
    -indels $GLOBALSCRATCH"/genomes/homo_sapiens/hg19/variation/Mills_and_1000G_gold_standard.indels.hg19_sorted.vcf" \
    -indels $GLOBALSCRATCH"/genomes/homo_sapiens/hg19/variation/1000G_phase1.indels.hg19_sorted.vcf" \
